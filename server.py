...
def receive(receivemsg):
    ...
    if msg1[0] == "checking":
        print("Do I receive c-------------")
        site_id_j = int(msg1[1])
        print("Do I receive c-------------0")
        checkback = "checkback$$"+str(site_id)
        print("Do I receive c-------------1")
        send_msg(sock,knownhosts,msg1[1],checkback)
        print("Do I receive c-------------2")
...
while True:
    ...
    if msg == 'Q':
       ...
       # send_msg(sock,knownhosts,sent_to,msg)
        ...
        checking = "checking$$"+str(site_id)
        send_all(sock,knownhosts,checking)
